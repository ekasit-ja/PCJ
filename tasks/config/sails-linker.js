...
module.exports = function(grunt) {
  ...
  grunt.config.set('sails-linker', {
    ...
    prodStyles: {
      ...
      files: {
        '.tmp/public/index.html': ['.tmp/public/min/production.001.min.css'],
        'views/**/*.html': ['.tmp/public/min/production.001.min.css'],
        'views/**/*.ejs': ['.tmp/public/min/production.001.min.css']
      }
    },
    ...
    prodStylesJade: {
      ...
      files: {
        'views/**/*.jade': ['.tmp/public/min/production.001.min.css']
      }
    },
